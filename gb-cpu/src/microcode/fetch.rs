    ...
    Opcode::try_from(byte).map_or_else(
        ...
        |opcode| {
            ...
            match opcode {
                ...
                Opcode::IncDE => ctl.push_to_current_cycle(&[read::de, inc::inc16, write::de]),
                Opcode::IncHL => ctl.push_to_current_cycle(&[read::hl, inc::inc16, write::hl]),
                Opcode::IncSP => ctl.push_to_current_cycle(&[read::sp, inc::inc16, write::sp]),
                ...
                Opcode::IncHLind => ctl.push_to_current_cycle(&[
                    read::hl,
                    read::ind,
                    inc::inc8,
                    read::hl,
                ...
                Opcode::DecBC => ctl.push_to_current_cycle(&[read::bc, dec::dec16, write::bc]),
                Opcode::DecDE => ctl.push_to_current_cycle(&[read::de, dec::dec16, write::de]),
                Opcode::DecHL => ctl.push_to_current_cycle(&[read::hl, dec::dec16, write::hl]),
                Opcode::DecSP => ctl.push_to_current_cycle(&[read::sp, dec::dec16, write::sp]),
                ...
                Opcode::DecHLind => ctl.push_to_current_cycle(&[
                    read::hl,
                    read::ind,
                    dec::dec8,
                    read::hl,
                ...
                Opcode::XorAB => {
                    ctl.push_to_current_cycle(&[read::b, read::a, logic::xor, write::a])
                }
                Opcode::XorAC => {
                    ctl.push_to_current_cycle(&[read::c, read::a, logic::xor, write::a])
                }
                Opcode::XorAD => {
                    ctl.push_to_current_cycle(&[read::d, read::a, logic::xor, write::a])
                }
                Opcode::XorAE => {
                    ctl.push_to_current_cycle(&[read::e, read::a, logic::xor, write::a])
                }
                Opcode::XorAH => {
                    ctl.push_to_current_cycle(&[read::h, read::a, logic::xor, write::a])
                }
                Opcode::XorAL => {
                ...
                Opcode::AndAB => {
                    ctl.push_to_current_cycle(&[read::b, read::a, logic::and, write::a])
                }
                Opcode::AndAC => {
                    ctl.push_to_current_cycle(&[read::c, read::a, logic::and, write::a])
                }
                Opcode::AndAD => {
                    ctl.push_to_current_cycle(&[read::d, read::a, logic::and, write::a])
                }
                Opcode::AndAE => {
                    ctl.push_to_current_cycle(&[read::e, read::a, logic::and, write::a])
                }
                Opcode::AndAH => {
                    ctl.push_to_current_cycle(&[read::h, read::a, logic::and, write::a])
                }
                Opcode::AndAL => {
                ...
                Opcode::SubAB => {
                    ctl.push_to_current_cycle(&[read::b, read::a, arithmetic::sub, write::a])
                }
                Opcode::SubAC => {
                    ctl.push_to_current_cycle(&[read::c, read::a, arithmetic::sub, write::a])
                }
                Opcode::SubAD => {
                    ctl.push_to_current_cycle(&[read::d, read::a, arithmetic::sub, write::a])
                }
                Opcode::SubAE => {
                    ctl.push_to_current_cycle(&[read::e, read::a, arithmetic::sub, write::a])
                }
                Opcode::SubAH => {
                    ctl.push_to_current_cycle(&[read::h, read::a, arithmetic::sub, write::a])
                }
                Opcode::SubAL => {
                    ctl.push_to_current_cycle(&[read::l, read::a, arithmetic::sub, write::a])
                }
                Opcode::SubAHL => ctl.push_to_current_cycle(&[
                    read::hl,
                    read::ind,
                    read::a,
                    arithmetic::sub,
                ...
                Opcode::SubA8 => {
                    ctl.push_to_current_cycle(&[read::byte, read::a, arithmetic::sub, write::a])
                }

                Opcode::SbcAA => {
                    ctl.push_to_current_cycle(&[read::a, read::a, arithmetic::sbc, write::a])
                }
                Opcode::SbcAB => {
                    ctl.push_to_current_cycle(&[read::b, read::a, arithmetic::sbc, write::a])
                }
                Opcode::SbcAC => {
                    ctl.push_to_current_cycle(&[read::c, read::a, arithmetic::sbc, write::a])
                }
                Opcode::SbcAD => {
                    ctl.push_to_current_cycle(&[read::d, read::a, arithmetic::sbc, write::a])
                }
                Opcode::SbcAE => {
                    ctl.push_to_current_cycle(&[read::e, read::a, arithmetic::sbc, write::a])
                }
                Opcode::SbcAH => {
                    ctl.push_to_current_cycle(&[read::h, read::a, arithmetic::sbc, write::a])
                }
                Opcode::SbcAL => {
                    ctl.push_to_current_cycle(&[read::l, read::a, arithmetic::sbc, write::a])
                }
                Opcode::SbcAHL => ctl.push_to_current_cycle(&[
                    read::hl,
                    read::ind,
                    read::a,
                    arithmetic::sbc,
                ...
                Opcode::SbcA8 => {
                    ctl.push_to_current_cycle(&[read::byte, read::a, arithmetic::sbc, write::a])
                }

                Opcode::AddHLBC => {
                    ctl.push_to_current_cycle(&[read::bc, read::hl, arithmetic::add_16, write::hl])
                }
                Opcode::AddHLDE => {
                    ctl.push_to_current_cycle(&[read::de, read::hl, arithmetic::add_16, write::hl])
                }
                Opcode::AddHLHL => {
                    ctl.push_to_current_cycle(&[read::hl, read::hl, arithmetic::add_16, write::hl])
                }
                Opcode::AddHLSP => {
                    ctl.push_to_current_cycle(&[read::sp, read::hl, arithmetic::add_16, write::hl])
                }

                Opcode::AddAA => {
                    ctl.push_to_current_cycle(&[read::a, read::a, arithmetic::add, write::a])
                }
                Opcode::AddAB => {
                    ctl.push_to_current_cycle(&[read::b, read::a, arithmetic::add, write::a])
                }
                Opcode::AddAC => {
                    ctl.push_to_current_cycle(&[read::c, read::a, arithmetic::add, write::a])
                }
                Opcode::AddAD => {
                    ctl.push_to_current_cycle(&[read::d, read::a, arithmetic::add, write::a])
                }
                Opcode::AddAE => {
                    ctl.push_to_current_cycle(&[read::e, read::a, arithmetic::add, write::a])
                }
                Opcode::AddAH => {
                    ctl.push_to_current_cycle(&[read::h, read::a, arithmetic::add, write::a])
                }
                Opcode::AddAL => {
                    ctl.push_to_current_cycle(&[read::l, read::a, arithmetic::add, write::a])
                }
                Opcode::AddAHL => ctl.push_to_current_cycle(&[
                    read::hl,
                    read::ind,
                    read::a,
                    arithmetic::add,
                ...
                Opcode::AddA8 => {
                    ctl.push_to_current_cycle(&[read::byte, read::a, arithmetic::add, write::a])
                }

                Opcode::AdcAA => {
                    ctl.push_to_current_cycle(&[read::a, read::a, arithmetic::adc, write::a])
                }
                Opcode::AdcAB => {
                    ctl.push_to_current_cycle(&[read::b, read::a, arithmetic::adc, write::a])
                }
                Opcode::AdcAC => {
                    ctl.push_to_current_cycle(&[read::c, read::a, arithmetic::adc, write::a])
                }
                Opcode::AdcAD => {
                    ctl.push_to_current_cycle(&[read::d, read::a, arithmetic::adc, write::a])
                }
                Opcode::AdcAE => {
                    ctl.push_to_current_cycle(&[read::e, read::a, arithmetic::adc, write::a])
                }
                Opcode::AdcAH => {
                    ctl.push_to_current_cycle(&[read::h, read::a, arithmetic::adc, write::a])
                }
                Opcode::AdcAL => {
                    ctl.push_to_current_cycle(&[read::l, read::a, arithmetic::adc, write::a])
                }
                Opcode::AdcAHL => ctl.push_to_current_cycle(&[
                    read::hl,
                    read::ind,
                    read::a,
                    arithmetic::adc,
                ...
                Opcode::AdcA8 => {
                    ctl.push_to_current_cycle(&[read::byte, read::a, arithmetic::adc, write::a])
                }
                ...
                Opcode::LdiHLA => {
                    ctl.push_to_current_cycle(&[read::a, read::hl, write::ind, inc::hl])
                }
                Opcode::LdiAHL => {
                    ctl.push_to_current_cycle(&[read::hl, read::ind, write::a, inc::hl])
                }

                Opcode::LddHLA => {
                    ctl.push_to_current_cycle(&[read::a, read::hl, write::ind, dec::hl])
                }
                Opcode::LddAHL => {
                    ctl.push_to_current_cycle(&[read::hl, read::ind, write::a, dec::hl])
                }

                Opcode::LdA8 => ctl.push_to_current_cycle(&[read::byte, write::a]),
                Opcode::LdB8 => ctl.push_to_current_cycle(&[read::byte, write::b]),
                Opcode::LdC8 => ctl.push_to_current_cycle(&[read::byte, write::c]),
                Opcode::LdD8 => ctl.push_to_current_cycle(&[read::byte, write::d]),
                Opcode::LdE8 => ctl.push_to_current_cycle(&[read::byte, write::e]),
                Opcode::LdH8 => ctl.push_to_current_cycle(&[read::byte, write::h]),
                Opcode::LdL8 => ctl.push_to_current_cycle(&[read::byte, write::l]),
                Opcode::LdHL8 => ctl.push_to_current_cycle(&[read::byte, read::hl, write::ind]),

                Opcode::Ld16SP => ctl.push_to_current_cycle(&[
                    read::sp,
                    read::byte,
                    read::byte,
                    write::ind16,
                ...
                Opcode::LdSPHL => ctl.push_to_current_cycle(&[read::hl, write::sp, utils::sleep]),
                Opcode::LdA16 => {
                    ctl.push_to_current_cycle(&[read::byte, read::byte, read::ind, write::a])
                }
                ...
                Opcode::LdAHL => ctl.push_to_current_cycle(&[read::hl, read::ind, write::a]),

                Opcode::LdABC => ctl.push_to_current_cycle(&[read::bc, read::ind, write::a]),
                Opcode::LdADE => ctl.push_to_current_cycle(&[read::de, read::ind, write::a]),
                ...
                Opcode::LdBHL => ctl.push_to_current_cycle(&[read::hl, read::ind, write::b]),
                ...
                Opcode::LdCHL => ctl.push_to_current_cycle(&[read::hl, read::ind, write::c]),
                ...
                Opcode::LdDHL => ctl.push_to_current_cycle(&[read::hl, read::ind, write::d]),
                ...
                Opcode::LdEHL => ctl.push_to_current_cycle(&[read::hl, read::ind, write::e]),
                ...
                Opcode::LdHHL => ctl.push_to_current_cycle(&[read::hl, read::ind, write::h]),
                ...
                Opcode::LdLHL => ctl.push_to_current_cycle(&[read::hl, read::ind, write::l]),
                ...
                Opcode::LdHLL => ctl.push_to_current_cycle(&[read::l, read::hl, write::ind]),

                Opcode::LdhAC => ctl.push_to_current_cycle(&[read::c, read::hram, write::a]),
                Opcode::LdhA8 => ctl.push_to_current_cycle(&[read::byte, read::hram, write::a]),

                Opcode::Ldh8A => ctl.push_to_current_cycle(&[read::a, read::byte, write::hram]),
                Opcode::LdhCA => ctl.push_to_current_cycle(&[read::a, read::c, write::hram]),

                Opcode::LdBCA => ctl.push_to_current_cycle(&[read::a, read::bc, write::ind]),
                Opcode::LdDEA => ctl.push_to_current_cycle(&[read::a, read::de, write::ind]),

                Opcode::CallNz => ctl.push_to_current_cycle(&[
                    read::byte,
                    read::byte,
                    not_zero,
                    read::pc,
                ...
                Opcode::CallZ16 => ctl.push_to_current_cycle(&[
                    read::byte,
                    read::byte,
                    zero,
                    read::pc,
                ...
                Opcode::Call16 => ctl.push_to_current_cycle(&[
                    read::byte,
                    read::byte,
                    read::pc,
                    dec::sp,
                ...
                Opcode::CallNc16 => ctl.push_to_current_cycle(&[
                    read::byte,
                    read::byte,
                    not_carry,
                    read::pc,
                ...
                Opcode::CallC16 => ctl.push_to_current_cycle(&[
                    read::byte,
                    read::byte,
                    carry,
                    read::pc,
                ...
                Opcode::RetNz => ctl.push_to_current_cycle(&[
                    utils::sleep,
                    not_zero,
                    read::sp,
                    read::ind,
                ...
                Opcode::RetZ => ctl.push_to_current_cycle(&[
                    utils::sleep,
                    zero,
                    read::sp,
                    read::ind,
                ...
                Opcode::Ret => ctl.push_to_current_cycle(&[
                    read::sp,
                    read::ind,
                    inc::sp,
                    read::sp,
                ...
                Opcode::RetNc => ctl.push_to_current_cycle(&[
                    utils::sleep,
                    not_carry,
                    read::sp,
                    read::ind,
                ...
                Opcode::RetC => ctl.push_to_current_cycle(&[
                    utils::sleep,
                    carry,
                    read::sp,
                    read::ind,
                ...
                Opcode::Rst00 => ctl.push_to_current_cycle(&[
                    read::pc,
                    dec::sp,
                    read::sp,
                    write::ind,
                ...
                Opcode::Rst08 => ctl.push_to_current_cycle(&[
                    read::pc,
                    dec::sp,
                    read::sp,
                    write::ind,
                ...
                Opcode::Rst10 => ctl.push_to_current_cycle(&[
                    read::pc,
                    dec::sp,
                    read::sp,
                    write::ind,
                ...
                Opcode::Rst18 => ctl.push_to_current_cycle(&[
                    read::pc,
                    dec::sp,
                    read::sp,
                    write::ind,
                ...
                Opcode::Rst20 => ctl.push_to_current_cycle(&[
                    read::pc,
                    dec::sp,
                    read::sp,
                    write::ind,
                ...
                Opcode::Rst28 => ctl.push_to_current_cycle(&[
                    read::pc,
                    dec::sp,
                    read::sp,
                    write::ind,
                ...
                Opcode::Rst30 => ctl.push_to_current_cycle(&[
                    read::pc,
                    dec::sp,
                    read::sp,
                    write::ind,
                ...
                Opcode::Rst38 => ctl.push_to_current_cycle(&[
                    read::pc,
                    dec::sp,
                    read::sp,
                    write::ind,
                ...
                Opcode::Rla => ctl.push_to_current_cycle(&[
                    read::a,
                    bitwise::rl,
                    flag::reset_flag_zero,
                    write::a,
                ]),
                Opcode::RrcA => ctl.push_to_current_cycle(&[
                    read::a,
                    bitwise::rrc,
                    flag::reset_flag_zero,
                    write::a,
                ]),
                Opcode::Rra => ctl.push_to_current_cycle(&[
                    read::a,
                    bitwise::rr,
                    flag::reset_flag_zero,
                    write::a,
                ]),
                Opcode::RlcA => ctl.push_to_current_cycle(&[
                    read::a,
                    bitwise::rlc,
                    flag::reset_flag_zero,
                    write::a,
                ...
                Opcode::AddSp8 => ctl.push_to_current_cycle(&[
                    read::sp,
                    read::byte,
