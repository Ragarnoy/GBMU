    ...
    Opcode::try_from(byte).map_or_else(
        ...
        |opcode| {
            ...
            match opcode {
                ...
                Opcode::XorAHL => {
                    ctl.push_cycle(&[read::hl, read::ind, read::a, logic::xor, write::a])
                }
                ...
                Opcode::AndAHL => {
                    ctl.push_cycle(&[read::hl, read::ind, read::a, logic::and, write::a])
                }
                ...
                Opcode::OrAHL => {
                    ctl.push_cycle(&[read::hl, read::ind, read::a, logic::or, write::a])
                }
