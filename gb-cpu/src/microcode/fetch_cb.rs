...
pub fn fetch_cb(ctl: &mut MicrocodeController, state: &mut State) -> MicrocodeFlow {
    ...
    OpcodeCB::try_from(byte).map_or_else(
        ...
        |opcode| {
            ...
            config_actions_for_opcode_cb(opcode, ctl);
            CONTINUE
        },
    )
}

fn config_actions_for_opcode_cb(opcode: OpcodeCB, ctl: &mut MicrocodeController) {
    match opcode {
        ...
        OpcodeCB::Bit0HL => ctl.push_cycle(&[read::hl, read::ind, bitwise::bit_0]),
        ...
        OpcodeCB::Bit1HL => ctl.push_cycle(&[read::hl, read::ind, bitwise::bit_1]),
        ...
        OpcodeCB::Bit2HL => ctl.push_cycle(&[read::hl, read::ind, bitwise::bit_2]),
        ...
        OpcodeCB::Bit3HL => ctl.push_cycle(&[read::hl, read::ind, bitwise::bit_3]),
        ...
        OpcodeCB::Bit4HL => ctl.push_cycle(&[read::hl, read::ind, bitwise::bit_4]),
        ...
        OpcodeCB::Bit5HL => ctl.push_cycle(&[read::hl, read::ind, bitwise::bit_5]),
        ...
        OpcodeCB::Bit6HL => ctl.push_cycle(&[read::hl, read::ind, bitwise::bit_6]),
        ...
        OpcodeCB::Bit7HL => ctl.push_cycle(&[read::hl, read::ind, bitwise::bit_7]),
        ...
        OpcodeCB::Set0HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::set_0, read::hl, write::ind])
        }
        ...
        OpcodeCB::Set1HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::set_1, read::hl, write::ind])
        }
        ...
        OpcodeCB::Set2HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::set_2, read::hl, write::ind])
        }
        ...
        OpcodeCB::Set3HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::set_3, read::hl, write::ind])
        }
        ...
        OpcodeCB::Set4HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::set_4, read::hl, write::ind])
        }
        ...
        OpcodeCB::Set5HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::set_5, read::hl, write::ind])
        }
        ...
        OpcodeCB::Set6HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::set_6, read::hl, write::ind])
        }
        ...
        OpcodeCB::Set7HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::set_7, read::hl, write::ind])
        }
        ...
        OpcodeCB::Res0HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::res_0, read::hl, write::ind])
        }
        ...
        OpcodeCB::Res1HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::res_1, read::hl, write::ind])
        }
        ...
        OpcodeCB::Res2HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::res_2, read::hl, write::ind])
        }
        ...
        OpcodeCB::Res3HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::res_3, read::hl, write::ind])
        }
        ...
        OpcodeCB::Res4HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::res_4, read::hl, write::ind])
        }
        ...
        OpcodeCB::Res5HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::res_5, read::hl, write::ind])
        }
        ...
        OpcodeCB::Res6HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::res_6, read::hl, write::ind])
        }
        ...
        OpcodeCB::Res7HL => {
            ctl.push_to_current_cycle(&[read::hl, read::ind, bitwise::res_7, read::hl, write::ind])
        }
