...
fn config_actions_for_opcode_cb(opcode: OpcodeCB, ctl: &mut MicrocodeController) {
    match opcode {
        ...
        OpcodeCB::Set0HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::set_0],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Set1HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::set_1],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Set2HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::set_2],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Set3HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::set_3],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Set4HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::set_4],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Set5HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::set_5],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Set6HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::set_6],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Set7HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::set_7],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Res0HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::res_0],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Res1HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::res_1],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Res2HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::res_2],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Res3HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::res_3],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Res4HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::res_4],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Res5HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::res_5],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Res6HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::res_6],
            &[read::hl, write::ind],
        ]),
        ...
        OpcodeCB::Res7HL => ctl.push_cycles(&[
            &[read::hl, read::ind, bitwise::res_7],
            &[read::hl, write::ind],
        ]),
